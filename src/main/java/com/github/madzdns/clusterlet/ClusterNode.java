...
public class ClusterNode implements INode, Externalizable {
	...
	private Set<ClusterAddress> backendAddresses;
	...
	public ClusterNode(final short id,
			final Set<ClusterAddress> synchAddresses,
			final Set<ClusterAddress> backendAddresses,
	...
	public String getKey() throws NoSuchElementException {
		...
		finally{keysLock.readLock().unlock();}
	}
	...
	public void addKey(String key) {
		...
		finally{keysLock.writeLock().unlock();}
	}
	...
	public Set<Short> getAwareIds() {
		...
		finally{idsLock.readLock().unlock();}
	}
	...
	protected boolean addAwareId(final short id) {
		...
		finally{idsLock.writeLock().unlock();}
	}
	...
	public void writeExternal(ObjectOutput out) throws IOException {
		...
		if(keyChain != null) {
			...
			for(Iterator<String> it= keyChain.iterator(); it.hasNext();) {
		...
		if(awareIds != null) {
			...
			for(Iterator<Short> it= awareIds.iterator(); it.hasNext();) {
		...
		out.writeObject(backendAddresses);
	...
	public void readExternal(ObjectInput in) throws IOException,
		...
		this.backendAddresses = (Set<ClusterAddress>) in.readObject();
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof ClusterNode) {
			...
			return ((ClusterNode)obj).getId()==this.getId();
		}
		return false;
	}
	...
	public String toString() {
		...
		.append(String.valueOf(backendAddresses))
	...
	public String toXmlString() {
		...
		.append("</synch-addrz>")
		.append("<backend-addrz>")
		.append(backendAddresses)
		.append("</backend-addrz>")
		.append("</edge>");
